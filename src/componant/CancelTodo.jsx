...
const CancleTodo = () => {
    useEffect (() => {
        todoListByStatus("Cancel");
    }, []);

    const cancelTodos = useSelector((state) => state.todos.cancelTodos);

    console.log(cancelTodos);
